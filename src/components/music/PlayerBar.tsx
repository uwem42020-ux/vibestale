...
export default function PlayerBar() {
  ...
  return (
    <div className="fixed bottom-16 md:bottom-0 left-0 right-0 bg-white border-t border-gray-200 z-40 px-4 py-2">
      <div className="flex items-center gap-3 max-w-3xl mx-auto">
        ...
        <div className="flex-1 min-w-0">
          <p className="text-sm font-medium text-gray-900 truncate">{currentTrack.trackName}</p>
          <p className="text-xs text-gray-500 truncate">{currentTrack.artistName}</p>
          {/* Progress bar */}
          <div className="flex items-center gap-2 mt-1">
            <span className="text-[10px] text-gray-400 tabular-nums">{formatTime(progress)}</span>
